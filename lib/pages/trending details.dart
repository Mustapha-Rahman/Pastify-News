...
class TrendingDetails extends StatefulWidget {
  ...
  TrendingDetails({ required this.trendingId});

  @override
  _PopularDetailsState createState() => _PopularDetailsState();
}

class _PopularDetailsState extends State<TrendingDetails> {

  final CollectionReference _trending=
      ...
      return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: FutureBuilder(
                future: _trending.doc(widget.trendingId).get(),
